...
generate_plugin_loader() {
    ...
    # Using 'EOF' prevents shell expansion inside the heredoc
    cat > "$loader_file" << 'EOF'
...
for plugin_dir in $HOME/.config/fish/librarium-plugins/*
    if test -d "$plugin_dir"
        # Source all .fish files found in the plugin's main directory
...
# Install plugins and generate the loader
install_plugins
generate_plugin_loader
